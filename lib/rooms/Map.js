            ...
            while ((input = player.inputQueue.shift())) {
                ...
                if (player.isAttacking) {
                    ...
                    this.state.spawnedMonsters.forEach((monster) => {
                        ...
                        if (dx < attackRange &&
                            dy < attackRange &&
                            !monster.hitQueue.some((hit) => hit.username === player.username && hit.attack === "attack")) {
                            monster.hitQueue.push(new RoomState_2.HitObjectSchema(player.username, "attack", 50));
                        }
                    });
                }
            }
