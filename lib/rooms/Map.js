        ...
        this.state.spawnedPlayers.forEach((player) => {
            ...
            while ((input = player.inputQueue.shift())) {
                ...
                if (input.attack && player.canAttack) {
                    ...
                    this.playerAttackHits.set(attackId, new Set());
                    setTimeout(() => {
