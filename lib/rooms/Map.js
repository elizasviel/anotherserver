...
class map extends colyseus_1.Room {
    ...
    //3 paramenters is suspect, in official docs there are only 2 -- yet this works anyway.
    async onJoin(client, options, auth) {
        ...
        const spawnedPlayer = new RoomState_2.SpawnedPlayer((0, uuid_1.v4)(), auth.username, auth.lastX || 100, // Default spawn position
        auth.lastY || 100, 0, // velocityX
        0, // velocityY
