...
exports.MyRoomState = exports.Portal = exports.SpawnedMonster = exports.SpawnedPlayer = exports.InputDataSchema = exports.SpawnedLoot = exports.Loot = exports.Obstacle = void 0;
...
class InputDataSchema extends schema_1.Schema {
    constructor() {
        super(...arguments);
        this.left = false;
        this.right = false;
...
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "left", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "right", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "up", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "down", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "jump", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "attack", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], InputDataSchema.prototype, "loot", void 0);
__decorate([
    (0, schema_1.type)("number"),
    __metadata("design:type", Number)
], InputDataSchema.prototype, "tick", void 0);
__decorate([
    (0, schema_1.type)("string"),
    __metadata("design:type", String)
], InputDataSchema.prototype, "username", void 0);
exports.InputDataSchema = InputDataSchema;
class SpawnedPlayer extends schema_1.Schema {
    constructor(id, username, x, y, velocityX, velocityY, experience, level, height, width, inventory, tick, isAttacking, isGrounded, inputQueue) {
        super();
        this.id = "";
        this.username = "";
        this.experience = 0;
...
__decorate([
    (0, schema_1.type)("number"),
    __metadata("design:type", Number)
], SpawnedPlayer.prototype, "tick", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
...
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], SpawnedPlayer.prototype, "isGrounded", void 0);
__decorate([
    (0, schema_1.type)({ map: "number" }),
    __metadata("design:type", Object)
], SpawnedPlayer.prototype, "inventory", void 0);
__decorate([
    (0, schema_1.type)([InputDataSchema]),
    __metadata("design:type", Array)
], SpawnedPlayer.prototype, "inputQueue", void 0);
...
__decorate([
    (0, schema_1.type)("number"),
    __metadata("design:type", Number)
], SpawnedMonster.prototype, "speed", void 0);
__decorate([
    (0, schema_1.type)("number"),
    __metadata("design:type", Number)
...
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], SpawnedMonster.prototype, "isGrounded", void 0);
__decorate([
    (0, schema_1.type)("boolean"),
    __metadata("design:type", Boolean)
], SpawnedMonster.prototype, "isHit", void 0);
