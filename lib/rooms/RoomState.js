...
exports.MyRoomState = exports.Portal = exports.SpawnedMonster = exports.HitObjectSchema = exports.SpawnedPlayer = exports.SpawnedLoot = exports.Loot = exports.Obstacle = void 0;
...
class SpawnedPlayer extends schema_1.Schema {
    constructor(id, username, x, y, velocityX, velocityY, experience, level, height, width, canAttack, canLoot, canJump, isAttacking, inputQueue) {
        super();
        this.id = "";
        this.username = "";
        this.experience = 0;
...
class HitObjectSchema extends schema_1.Schema {
    constructor(username, attack, damage) {
        super();
        this.username = username;
        this.attack = attack;
        this.damage = damage;
...
__decorate([
    (0, schema_1.type)("string"),
    __metadata("design:type", String)
], HitObjectSchema.prototype, "username", void 0);
__decorate([
    (0, schema_1.type)("string"),
    __metadata("design:type", String)
], HitObjectSchema.prototype, "attack", void 0);
__decorate([
    (0, schema_1.type)("number"),
    __metadata("design:type", Number)
], HitObjectSchema.prototype, "damage", void 0);
exports.HitObjectSchema = HitObjectSchema;
...
__decorate([
    (0, schema_1.type)([HitObjectSchema]),
    __metadata("design:type", Array)
], SpawnedMonster.prototype, "hitQueue", void 0);
