...
exports.MyRoomState = exports.SpawnedMonster = exports.SpawnedPlayer = exports.SpawnedLoot = exports.Obstacle = void 0;
...
class SpawnedPlayer extends schema_1.Schema {
    constructor(id, name, x, y, velocityX, velocityY, experience, level, height, width, inventory, tick, isAttacking, isGrounded, inputQueue) {
        super();
        this.id = "";
        this.name = "";
        this.experience = 0;
...
__decorate([
    (0, schema_1.type)("string"),
    __metadata("design:type", String)
], SpawnedPlayer.prototype, "name", void 0);
__decorate([
    (0, schema_1.type)("number"),
    __metadata("design:type", Number)
...
class MyRoomState extends schema_1.Schema {
    constructor() {
        super(...arguments);
        this.spawnedPlayers = new schema_1.MapSchema();
...
__decorate([
    (0, schema_1.type)({ map: SpawnedPlayer }),
